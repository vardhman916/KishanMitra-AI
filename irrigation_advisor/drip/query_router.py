...
class DripQueryRouter:
    def __init__(self, engine: DripCSVEngine):
        self.engine = engine
    ...
    def handle_query(self, question):
        ...
        if "cost" in question_lower or "price" in question_lower:
            if hectare:
                ...
                response["cost"] = f"Estimated drip irrigation cost for {hectare} hectare is Rs.{cost}"
            else:
            ...
            if crop:
                ...
                if crop_data:
                    response["crop_response"] = (
                        f"Under drip irrigation, {crop.capitalize()} can save "
